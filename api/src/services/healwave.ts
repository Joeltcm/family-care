...
function analyteCode(name: string) {
  ...
  const aliases: Record<string, string> = {
    ...
    'PROTEINA C REACTIVA': 'CRP', 'PROTEINA C-REACTIVA': 'CRP', PCR: 'CRP',
    'VELOCIDAD DE SEDIMENTACION': 'ESR', 'VELOCIDAD DE SEDIMENTACION GLOBULAR': 'ESR', VSG: 'ESR',
    'FACTOR REUMATOIDE': 'RF', FR: 'RF',
    'ANTI CCP': 'ANTI_CCP', 'ANTI-CCP': 'ANTI_CCP', 'ANTICUERPOS ANTI CCP': 'ANTI_CCP', 'ANTICUERPO ANTI CCP': 'ANTI_CCP', ACPA: 'ANTI_CCP',
    'ALANINO AMINOTRANSFERASA': 'ALT', TGP: 'ALT', ALAT: 'ALT', 'TRANSAMINASA GLUTAMICO PIRUVICA': 'ALT',
    'ASPARTATO AMINOTRANSFERASA': 'AST', TGO: 'AST', ASAT: 'AST', 'TRANSAMINASA GLUTAMICO OXALACETICA': 'AST',
    CREATININA: 'CREA', CREAT: 'CREA', 'FILTRADO GLOMERULAR': 'EGFR', 'TASA DE FILTRACION GLOMERULAR': 'EGFR', TFG: 'EGFR', TFGE: 'EGFR',
  };
