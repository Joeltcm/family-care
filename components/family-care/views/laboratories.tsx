...
export function Laboratories({ profile, patient, canEdit, canExport, onRegister, onNotice, revision }: { profile: string; patient?: FamilyCarePatient; canEdit: boolean; canExport: boolean; onRegister: () => void; onNotice: Notify; revision: number }) {
