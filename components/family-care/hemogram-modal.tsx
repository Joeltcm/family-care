  ...
  return <div className="modal-backdrop" role="presentation" onMouseDown={onClose}>
    <section className="profile-modal lab-modal" role="dialog" aria-modal="true" aria-labelledby="hemogram-title" onMouseDown={(event) => event.stopPropagation()}>
      ...
      <form onSubmit={save}>
        ...
        <label className="consent-check"><input type="checkbox" checked={aiConsent} onChange={(event) => setAiConsent(event.target.checked)} /><span>Autorizo enviar una copia preparada del informe a DeepSeek únicamente para transcribir valores. Si la respuesta llega vacía, se hará un solo reintento. No se genera diagnóstico ni se guarda este análisis como expediente.</span></label>
